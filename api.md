...
| 参数名       |  类型  | 描述                                                         | 默认值 | 是否必填 |
| :---------- | :----: | :----------------------------------------------------------- | :----: | :------: |
| stop_interval     | number | 触发告警的停留时长阈值                                   |   ""   |   Yes    |

#### 单次空转时间超长告警
| 参数名       |  类型  | 描述                                                         | 默认值 | 是否必填 |
| :---------- | :----: | :----------------------------------------------------------- | :----: | :------: |
| idle_interval     | number | 触发告警的引擎空转时长阈值                                     |   ""   |   Yes    |

#### 单次引擎工作时间超长告警

| 参数名       |  类型  | 描述                                                         | 默认值 | 是否必填 |
| :---------- | :----: | :----------------------------------------------------------- | :----: | :------: |
| engine_on_interval     | number | 触发告警的引擎工作时长阈值                          |   ""   |   Yes    |

#### 保养到期告警

| 参数名       |  类型  | 描述                                                         | 默认值 | 是否必填 |
| :---------- | :----: | :----------------------------------------------------------- | :----: | :------: |
| type    | number | 监控的类型参数（0 时间、1 里程、2 发动机）                          |   ""   |   Yes    |
| value    | number | 监控类型的值                                                     |   ""   |   Yes    |
...
| period_value    | number | 时间周期类型（0 everyday、1 everyweek、2 everymonth）         |   ""   |   Yes    |
